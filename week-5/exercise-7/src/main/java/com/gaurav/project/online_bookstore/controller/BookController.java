...
public class BookController {
    ...
    @GetMapping("/params")
    public List<Book> getBooksByParams(@RequestParam(required = false) String title, @RequestParam(required = false) String author) {
        return bookService.getBooksByParams(title, author);
    }
}
